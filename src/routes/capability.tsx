...
import {
  ...
  Smartphone, Brain, Database, Users, FileCheck2, Layers, Download, Phone,
    ...
    <section id="contact" className="py-24 section-alt">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
          ...
          <span className="inline-flex items-center gap-2"><Database className="h-4 w-4 text-primary" /> info@piscalex.us</span>
        </div>
      </div>
    </section>
  );
...
function Footer() {
  return (
    <footer className="border-t border-border/60 py-10 text-center text-xs text-muted-foreground">
      © {new Date().getFullYear()} PI Solutions and Consulting PVT Limited · Capability Statement
    </footer>
  );
}
