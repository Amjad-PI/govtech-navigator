...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Trusted U.S. State and Local Government IT consulting subcontractor delivering digital transformation, AI, and cloud modernization." },
