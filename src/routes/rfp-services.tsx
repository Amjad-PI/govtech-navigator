...
import {
  ...
  Smartphone, Brain, Database, Users, FileCheck2, Layers, Phone,
      ...
      <div className="max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-3xl animate-fade-up">
          <div className="inline-flex items-center gap-2 glass px-3 py-1.5 rounded-full text-[11px] uppercase tracking-[0.18em] text-muted-foreground mb-6">
            <ShieldCheck className="h-3.5 w-3.5 text-primary" /> Procurement Lifecycle Support
          </div>
          <h1 className="font-display text-4xl md:text-5xl lg:text-[3.6rem] font-semibold leading-[1.05] text-gradient">
            End-to-End RFP Lifecycle Support
          </h1>
          <p className="mt-6 text-muted-foreground text-lg md:text-xl leading-relaxed max-w-2xl">
            From opportunity evaluation to post-award execution, PIScaleX provides structured support across every stage of the procurement lifecycle.
          </p>
    ...
    <section id="contact" className="py-24 section-alt">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
          <span className="inline-flex items-center gap-2"><Phone className="h-4 w-4 text-primary" /> +1 (703) 666-7959</span>
          <span className="inline-flex items-center gap-2"><Mail className="h-4 w-4 text-primary" /> info@piscalex.us</span>
        </div>
      </div>
    </section>
  );
...
function Footer() {
  return (
    <footer className="border-t border-border/60 py-10 text-center text-xs text-muted-foreground">
      © {new Date().getFullYear()} PI Solutions and Consulting PVT Limited · RFP Services
    </footer>
  );
}
