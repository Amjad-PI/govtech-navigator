  ...
  head: () => ({
    meta: [
      { title: "PIScaleX — U.S. SLED Government IT Partner" },
      {
        name: "description",
        content:
          "Trusted U.S. State and Local Government IT subcontractor. Custom Apps, AI/ML, Data Analytics, Cloud Migration. NAICS 541612, 541519.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Custom Application Development, AI/ML, Data Analytics, and Cloud Migration for U.S. SLED agencies and prime contractors.",
      },
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 border-b border-border/60 backdrop-blur-xl bg-background/70">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <a
          href="#partner"
          className="inline-flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-lg bg-accent text-accent-foreground hover:opacity-90 transition"
        >
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-12 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-6 animate-fade-up">
          ...
          <h1 className="relative text-4xl sm:text-5xl lg:text-[3.9rem] font-bold leading-[1.05] tracking-tight">
            <span
              className="absolute -inset-4 -z-10 bg-primary/10 blur-3xl rounded-full"
              aria-hidden
            />
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            <a
              href="#partner"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border border-primary/40 text-primary hover:bg-primary/10 backdrop-blur-sm transition-all"
            >
              Partner With Us
            </a>
          </div>
          ...
          <div className="mt-10 flex flex-wrap gap-2">
            {[
              ...
              <span
                key={b.label}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-border bg-background/40 backdrop-blur-sm text-xs text-muted-foreground"
              >
        ...
        <div className="lg:col-span-6 relative animate-fade-up" style={{ animationDelay: "0.15s" }}>
          <div className="relative group">
            <div
              className="absolute -inset-6 bg-gradient-to-br from-primary/40 via-primary/10 to-accent/20 blur-2xl rounded-[32px] opacity-70 group-hover:opacity-90 transition-opacity"
              aria-hidden
            />
              ...
              <div className="absolute bottom-5 left-5 right-5 glass rounded-xl px-4 py-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-semibold text-foreground">
                    AI-Ready Government Infrastructure
                  </div>
        ...
        <div className="mt-12 grid lg:grid-cols-3 gap-6">
          ...
          <article className="lg:col-span-2 glass rounded-2xl p-8 relative overflow-hidden group hover:border-primary/30 transition">
            <div className="absolute top-6 right-6 flex items-center gap-2">
              <span className="px-2.5 py-1 rounded-md bg-primary/15 border border-primary/30 text-primary text-xs font-semibold">
                CO
              </span>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {["WordPress", "WCAG 2.2", "UX Design", "Accessibility", "Government CMS"].map(
                (t) => (
                  <span
                    key={t}
                    className="px-2.5 py-1 rounded-md border border-border text-xs text-muted-foreground bg-white/[0.02]"
                  >
                    {t}
                  </span>
                ),
          ...
          {[1, 2].map((i) => (
            <article
              key={i}
              className="rounded-2xl p-8 border-2 border-dashed border-border bg-card/40 backdrop-blur flex flex-col items-center justify-center text-center min-h-[320px] hover:border-primary/30 transition"
            >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#f8fafc] via-[#eff6ff] to-[#e0f2fe] shadow-[0_24px_80px_-24px_rgba(15,23,42,0.25)] border border-[#dbeafe]/60">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <svg
              className="absolute -top-24 -right-24 w-[500px] h-[500px] text-[#bfdbfe]/40 animate-pulse-glow"
              viewBox="0 0 500 500"
              fill="none"
            >
            ...
            <svg
              className="absolute -bottom-16 -left-16 w-[400px] h-[400px] text-[#dbeafe]/50 animate-pulse-glow"
          ...
          <div
            className="absolute top-20 right-32 h-2 w-2 rounded-full bg-[#60a5fa]/40 animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute bottom-12 left-20 h-2.5 w-2.5 rounded-full bg-[#3b82f6]/25 animate-pulse"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute bottom-24 left-40 h-2 w-2 rounded-full bg-[#93c5fd]/35 animate-pulse"
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center p-10 lg:p-16">
              ...
              <div className="relative">
                <div className="h-48 w-48 lg:h-56 lg:w-56 rounded-3xl bg-gradient-to-br from-[#1e3a5f] to-[#0f172a] flex items-center justify-center shadow-[0_20px_60px_-15px_rgba(30,58,95,0.5)]">
                  <div className="relative">
                    ...
                    <div
                      className="absolute -bottom-1 -left-2 h-3 w-3 rounded-full bg-[#60a5fa] animate-pulse shadow-[0_0_8px_3px_rgba(96,165,250,0.4)]"
            ...
            {/* Right: text and CTA */}
            <div
              className="text-center lg:text-left animate-fade-up"
...
const services = [
  {
    ...
    desc: "Multi-year roadmaps aligned to agency mission and budget cycles.",
  },
  {
    icon: Layers,
    title: "Government Digital Roadmaps",
    desc: "Phased modernization plans across legacy systems and citizen channels.",
  },
  {
    icon: Gauge,
    title: "Agency Technology Assessments",
    desc: "End-to-end audits of architecture, governance, and operational risk.",
  },
  {
    icon: Users,
    title: "State CIO Office Support",
    desc: "Embedded advisors for procurement, vendor strategy, and delivery oversight.",
  },
  {
    icon: ShieldCheck,
    title: "IT Governance Consulting",
    desc: "Policy, compliance, and standards aligned to NIST and state mandates.",
  },
  {
    icon: Brain,
    title: "AI-Powered Citizen Services",
    desc: "Conversational, predictive, and decision-support systems for agencies.",
  },
  {
    icon: Database,
    title: "Data Modernization",
    desc: "Unified data platforms, lineage, and analytics for state operations.",
  },
  {
    icon: Cloud,
    title: "Cloud Infrastructure Transformation",
    desc: "Secure migration to GovCloud, FedRAMP-aware, and hybrid environments.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((s) => (
            <div
              key={s.title}
              className="group glass rounded-xl p-6 hover:translate-y-[-2px] hover:border-primary/30 transition-all"
            >
...
const whys = [
  ...
  "Government Efficiency Alignment",
  "Accessibility-Focused Development",
  "AI & Automation Readiness",
  "Secure Cloud Migration",
  "Prime Contractor Collaboration",
  "Agile Government Delivery",
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5">
          ...
          <div className="mt-8 flex flex-wrap gap-2">
            {["920-40 Software", "️920-45 Maintenance", "918-00 Technology"].map((c) => (
              <span
                key={c}
        ...
        <div className="lg:col-span-7 grid sm:grid-cols-2 gap-3">
          {whys.map((w, i) => (
            <div
              key={w}
              className="glass rounded-xl px-5 py-4 flex items-start gap-3 hover:border-primary/30 transition"
            >
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="glass rounded-2xl p-8 relative overflow-hidden">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs px-2 py-1 rounded-md bg-accent/15 text-accent border border-accent/30">
                +12.4%
              </span>
            </div>
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-5 text-muted-foreground text-lg">
                A flexible subcontracting model engineered for U.S. prime contractors — blending
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={item.t}
                  className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card/40"
                >
